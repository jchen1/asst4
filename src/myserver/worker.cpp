...
// Executes a task and sends the response. Used in the threadpool task.
void worker_do_task(const Request_msg& req, Response_msg& resp) {
...
void worker_handle_request(const Request_msg& req) {
  ...
  wstate.tp.add_task(worker_do_task, req, resp);
}
